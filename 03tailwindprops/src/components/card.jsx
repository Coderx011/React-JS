...
function Card({username="zeeshan"}) {
    console.log(username);
  return (
    <div className="flex font-sans bg-slate-100 rounded mb-4">
  <div className="flex-none w-56 relative">
    <img src="https://images.pexels.com/photos/3225517/pexels-photo-3225517.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" className="absolute inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
  </div>
